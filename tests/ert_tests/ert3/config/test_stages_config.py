...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            ...
            ert.data.RecordTransformationDirectionality.FROM_RECORD,
            id="serialization",
        ),
        pytest.param(
            [
        ...
        pytest.param(
            ...
            marks=pytest.mark.raises(
                ...
                match=".+cannot transform in direction: input",
...
def test_transformations(
    ...
    if direction == ert.data.RecordTransformationDirectionality.FROM_RECORD:
